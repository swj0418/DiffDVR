...
#image = preprocess(Image.open("test_image.png")).unsqueeze(0)
#text = tokenizer(["a diagram", "a dog", "a cat", "a head"])
...
if __name__=='__main__':
  ...
  # Load image and embed using CLIP
  gtimage = preprocess(Image.open("test_ref.png")).cuda().unsqueeze(0)
  gtimage = gtimage.float()

  gtembedding = clipmodel.encode_image(gtimage)
  print("GT embedding shape: ", gtembedding.shape)
