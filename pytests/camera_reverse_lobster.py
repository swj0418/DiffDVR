...
if __name__ == '__main__':
    ...
    initial_tf = torch.tensor([[
        # r,g,b,a,pos
        [0.2, 0.9, 0.5, 0.5 * opacity_scaling, 0],
        [0.2, 0.9, 0.5, 0.5 * opacity_scaling, 0.1],
        [0.1, 0.4, 0.7, 0.5 * opacity_scaling, 0.3],
        [0.6, 0.6, 0.3, 0.5 * opacity_scaling, 0.5],
        [0.3, 0.2, 0.2, 0.5 * opacity_scaling, 0.7],
